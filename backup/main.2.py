...
# Inisialisasi webcam
cap = cv2.VideoCapture('rtsp://192.168.5.163:554/live/av1')
...
while True:
    ...
    if location is not None:
        ...
        if result:
            ...
            # Cetak nomor plat di terminal
            print("Nomor Plat:", text)

            # Gambar teks dan kotak pembatas pada gambar asli
            font = cv2.FONT_HERSHEY_SIMPLEX
            frame = cv2.putText(frame, text=text, org=(location[0][0][0], location[1][0][1] + 60), fontFace=font,
